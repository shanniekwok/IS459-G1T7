...
# Define the DAG dependencies - Updated to put Glue crawler before ML job
cluster_creator >> etl_step_adder >> etl_step_checker >> glue_crawler_task >> ml_forest_step_adder >> ml_forest_step_checker >> weather_api_step_adder >> weather_api_step_checker >> forecast_step_adder >> forecast_step_checker >> cluster_terminator